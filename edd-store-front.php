 ...
 *
 * The template for displaying the EDD store front.
 *
 * @package Peddle
 */
				...
				<div class="col-lg-4 product">
					...
					<div class="product-description">
						...
						<?php if ( edd_has_variable_prices( get_the_ID() ) ) : ?>
							<a class="product-price-wrap" href="<?php the_permalink(); ?>"><span class="product-price"><?php _e( 'Starting at: ', 'peddle'); edd_price( get_the_ID() ); ?></span></a>
						<?php elseif ( '0' != edd_get_download_price( get_the_ID() ) && ! edd_has_variable_prices( get_the_ID() ) ) : ?>	
							<a class="product-price-wrap" href="<?php the_permalink(); ?>"><span class="product-price"><?php _e( 'Price: ', 'peddle' ); edd_price( get_the_ID() ); ?></span></a>
						<?php else : ?>
							<a class="product-price-wrap" href="<?php the_permalink(); ?>"><span class="product-price"><?php _e( 'Free Download','peddle' ); ?></span></a>
						<?php endif; ?>
